...
public class LazyUsuarioDataModel extends LazyDataModel<Usuario> implements Serializable {
    ...
    private static final Logger LOGGER = Logger.getLogger(LazyUsuarioDataModel.class.getName());
    private static final long serialVersionUID = 1L;
    private UsuarioBusinessBean businessBean;
    private FiltroUsuario filtro;

    public LazyUsuarioDataModel(UsuarioBusinessBean businessBean, FiltroUsuario filtro, Long rowCount, Integer pageSize) {
