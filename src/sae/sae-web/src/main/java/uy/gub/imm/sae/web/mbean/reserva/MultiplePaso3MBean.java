...
public class MultiplePaso3MBean extends BaseMBean {
    ...
    static Logger logger = Logger.getLogger(MultiplePaso3MBean.class);
    ...
    private void marcarReserva(Disponibilidad disponibilidad) throws RolException, BusinessException, UserException {
        ...
        Reserva reserva = agendarReservasEJB.marcarReserva(disponibilidad, OrigenReserva.WEB, token, ipOrigen);
