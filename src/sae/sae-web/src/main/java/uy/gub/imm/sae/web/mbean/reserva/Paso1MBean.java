 ...
 * https://<servidor>:<puerto>/<dominio>/agendarReserva/Paso1.xhtml?e=1000001&a=29&u=http%3A%2F%2Fgoogle.com.uy&p=13.61.789456;13.60.CI;13.62.@@email
 * 
 */
@ManagedBean 
@ViewScoped
public class Paso1MBean extends BaseMBean {
    ...
    public void init() {
        try {
            ...
            //(necesita estos datos para determinar si la agenda particular requiere CDA o IDURUGUAY)
            ...
            try {
                ...
                //Al código del usuario se le añade un número randómico para evitar conflictos con otros usuarios
    ...
    public String siguientePaso() {
        if (sesionMBean.getRecurso() != null) {
            try {
                ...
                LOGGER.error("Error al avanzar al siguiente paso", ex);
                return null;
            }
        } else {
