...
public class MultiplePasoFinalMBean extends BaseMBean {
    ...
    private final Logger logger = Logger.getLogger(MultiplePasoFinalMBean.class);
    ...
    public boolean confirmarReservas() {
        ...
        try {
            ...
            tokenReserva = agendarReservasEJB.confirmarReservasMultiples(sesionMBean.getEmpresaActual().getId(), tokenReserva.getId(), transaccionPadreId, pasoPadre, false, new InformacionRequestDTO(httpRequest.getScheme(), httpRequest.getServerName(), httpRequest.getContextPath(), httpRequest.getServerPort()));
            ...
            comunicacionesEJB.enviarComunicacionesConfirmacion(sesionMBean.getEmpresaActual(), linkCancelacion, linkModificacion, tokenReserva, sesionMBean.getIdiomaActual(),
