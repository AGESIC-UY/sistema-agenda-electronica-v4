...
public class ModificarPaso2MBean extends BaseMBean {
    ...
    private static final Logger logger = Logger.getLogger(ModificarPaso2MBean.class);
    ...
    public void init() {
        try {
            ...
            logger.error("Error init ModificarPaso2MBean", e);
            errorInit = true;
        }
    }
    ...
    public String siguientePaso() {
        ...
        try {
            Reserva r = agendarReservasEJB.marcarReserva(disponibilidadSeleccionada, OrigenReserva.WEB, null, null);
    ...
    private void recomputarFusionadasYDerivadas() {
        ...
        primerasDisponibilidades = sinDup.stream()
