...
@ManagedBean
@ViewScoped
public class ModificarPasoFinalMBean extends BaseMBean {

    private Logger LOGGER = Logger.getLogger(ModificarPasoFinalMBean.class);
        ...
        try {
            ...
            if (campos.getChildCount() == 0 && recurso != null) {
                ...
                FormularioDinamicoReserva formularioDin = new FormularioDinamicoReserva(valores, sesionMBean.getFormatoFecha(),
                        new Locale(sesionMBean.getIdiomaActual()));
