 ...
 * https://<servidor>:<puerto>/<dominio>/reservaMultiple/Paso1.xhtml?e=1000001&a=29
 * 
 */
@ManagedBean
@ViewScoped
            ...
            if (sesionMBean.getAgenda() != null) {
                ...
                if (sToken != null) {
                    ...
                    if (token == null) {
                        ...
                        errorInit = true;
                    } else if (token.getEstado() == Estado.R) {
                        ...
                        Long tiempoMaximo = configuracionEJB.getLong("RESERVA_MULTIPLE_PENDIENTE_TIEMPO_MAXIMO",sesionMBean.getEmpresaActual().getOrganismoId());
