...
public class NextPageLinkRenderer extends PageLinkRenderer implements PaginatorElementRenderer {
    ...
    public void render(FacesContext context, Pageable pageable) throws IOException {
        ...
        super.render(context, pageable, UIData.PAGINATOR_NEXT_PAGE_LINK_CLASS, UIData.PAGINATOR_NEXT_PAGE_ICON_CLASS, disabled, ariaMessage, pageable.getPaginatorNextPageLabel());
    }
}
