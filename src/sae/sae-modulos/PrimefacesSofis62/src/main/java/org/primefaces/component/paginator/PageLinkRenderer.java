...
public class PageLinkRenderer {
    ...
    public void render(FacesContext context, Pageable pageable, String linkClass, String iconClass, boolean disabled, String ariaLabel) throws IOException {
        render(context, pageable, linkClass, iconClass, disabled, ariaLabel, null);
    }

    public void render(FacesContext context, Pageable pageable, String linkClass, String iconClass, boolean disabled, String ariaLabel, String title) throws IOException {
        ...
        //Sofis: permitir definir un title
        if(title!=null){
