...
public class FirstPageLinkRenderer extends PageLinkRenderer implements PaginatorElementRenderer {
    ...
    public void render(FacesContext context, Pageable pageable) throws IOException {
        ...
        super.render(context, pageable, UIData.PAGINATOR_FIRST_PAGE_LINK_CLASS, UIData.PAGINATOR_FIRST_PAGE_ICON_CLASS, disabled, ariaMessage, pageable.getPaginatorFirstPageLabel());
    }
}
