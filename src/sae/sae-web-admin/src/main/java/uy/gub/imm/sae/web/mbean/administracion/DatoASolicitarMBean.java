...
public class DatoASolicitarMBean extends BaseMBean {
    ...
    @ManagedProperty(value = "#{datoASSessionMBean}")
    private DatoASSessionMBean datoASSessionMBean;

    private List<SelectItem> listaAgrupaciones = new ArrayList<>();
    private List<SelectItem> listaTipos = new ArrayList<>();
        ...
        if (datoASSessionMBean.getDatoSeleccionado() != null) {
            ...
            try {
                ...
                if (this.visualizarLargoMax == true && datoModificar.getLargo() == null) {
                    ...
                    hayError = true;
                } else if (this.visualizarLargoMax == true && datoModificar.getLargo() < 1) {
                ...
                if (datoModificar.getIncluirEnLlamador() && datoModificar.getLargoEnLlamador() == null) {
                    ...
                    hayError = true;
                } else if (datoModificar.getIncluirEnLlamador() && datoModificar.getOrdenEnLlamador() < 1) {
                ...
                if (datoModificar.getIncluirEnLlamador() && datoModificar.getOrdenEnLlamador() == null) {
                    ...
                    hayError = true;
                } else if (datoModificar.getIncluirEnLlamador() && datoModificar.getLargoEnLlamador() < 1) {
                ...
                if (datoModificar.getFila() == null) {
                    ...
                    hayError = true;
                } else if (datoModificar.getFila() < 1) {
                ...
                if (datoModificar.getIncluirEnReporte() && datoModificar.getAnchoDespliegue() == null) {
                    ...
                    hayError = true;
                } else if (datoModificar.getIncluirEnReporte() && datoModificar.getAnchoDespliegue() < 1) {
    ...
    private void cargarListaAgrupaciones() {
        ...
        if (sessionMBean.getRecursoMarcado() != null) {
            try {
                ...
                listaAgrupaciones = new ArrayList<>();
    ...
    public void eliminarDato() {
        ...
        } else if (d != null && !d.getBorrarFlag()) {
    ...
    public void crearDato(ActionEvent e) {
        ...
        try {
            ...
            if (datoNuevo.getFila() == null) {
                addErrorMessage(sessionMBean.getTextos().get("la_fila_del_dato_es_obligatoria"), "formCrear:VFila");
                hayError = true;
            } else if (datoNuevo.getFila() < 1) {
            ...
            if (datoNuevo.getLargo() == null && this.visualizarLargoMax == true) {
                ...
                hayError = true;
            } else if (this.visualizarLargoMax == true && datoNuevo.getLargo() < 1) {
            ...
            if (datoNuevo.getIncluirEnReporte()
                ...
                hayError = true;
            } else if (datoNuevo.getIncluirEnReporte() && datoNuevo.getAnchoDespliegue() < 1) {
            ...
            if (datoNuevo.getIncluirEnLlamador() && datoNuevo.getLargoEnLlamador() == null) {
                ...
                hayError = true;
            } else if (datoNuevo.getIncluirEnLlamador() && datoNuevo.getOrdenEnLlamador() < 1) {
            ...
            if (datoNuevo.getIncluirEnLlamador() && datoNuevo.getOrdenEnLlamador() == null) {
                ...
                hayError = true;
            } else if (datoNuevo.getIncluirEnLlamador() && datoNuevo.getLargoEnLlamador() < 1) {
