...
//    private Map<Integer, Organismo> mapOrganismos = new HashMap<>();
//    private List<SelectItem> organismos = new ArrayList<>(0);

    //Datos de las unidades ejecutoras 
    private Map<Integer, UnidadEjecutora> mapUnidadesEjecutoras = new HashMap<>();
    private List<SelectItem> unidadesEjecutoras = new ArrayList<>(0);
...
//        mapOrganismos = new HashMap<>();
//        organismos = new ArrayList<>(0);
//        organismos.add(new SelectItem(0, "Sin especificar"));
//        if (orgs == null) {
//            return;
//        }
//        organismos = new ArrayList<>(orgs.size());
//        organismos.add(new SelectItem(0, "Sin especificar"));
...
//    }
    ...
    public void setUnidadesEjecutoras(List<UnidadEjecutora> ues) {
        mapUnidadesEjecutoras = new HashMap<>();
        unidadesEjecutoras = new ArrayList<>(0);
        unidadesEjecutoras.add(new SelectItem(0, "Sin especificar"));
        if (ues == null) {
            return;
        }
        unidadesEjecutoras = new ArrayList<>(ues.size());
        unidadesEjecutoras.add(new SelectItem(0, "Sin especificar"));
    ...
    public List<SelectItem> getFormatosFecha() {
        List<SelectItem> formatos = new ArrayList<>();
