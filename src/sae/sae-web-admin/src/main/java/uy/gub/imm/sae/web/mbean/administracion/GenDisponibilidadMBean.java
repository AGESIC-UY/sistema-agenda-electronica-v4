...
public class GenDisponibilidadMBean extends BaseMBean {
    ...
    @ManagedProperty(value = "#{genDispSessionMBean}")
        ...
        try {
            if (sessionMBean.getRecursoMarcado() != null) {
                if (v.getFechaInicial() != null && v.getFechaFinal() != null
                    ...
                    Integer i = 0;
                    List<CupoPorDia> lista_cupos = new ArrayList<>();
                    ...
                    cuposAux = new RowList<>(lista_cupos);
                } else {
    ...
    public void configurarDisponibilidadesDelDiaModif() {
        ...
        List<DisponibilidadReserva> dispMatutinas = new ArrayList<>();
        List<DisponibilidadReserva> dispVespertinas = new ArrayList<>();
        ...
        genDispSessionMBean.setDisponibilidadesDelDiaMatutinaModif(new RowList<>(dispMatutinas));
        genDispSessionMBean.setDisponibilidadesDelDiaVespertinaModif(new RowList<>(dispVespertinas));
    }
    ...
    public void generarDisponibilidades() {
        ...
        try {
            ...
            if (genDispSessionMBean.getFechaInicial() == null) {
                ...
                hayError = true;
            } else if (genDispSessionMBean.getFechaInicial().before(hoy.getTime())) {
            ...
            if (genDispSessionMBean.getFechaFinal() == null) {
                ...
                hayError = true;
            } else if (genDispSessionMBean.getFechaFinal().before(hoy.getTime())) {
            ...
            try {
                ...
                List<Date> horasConflicto = disponibilidadesEJB.generarDisponibilidades(sessionMBean.getRecursoMarcado(), genDispSessionMBean.getFechaModelo(), ventana, genDispSessionMBean.getDiasAplicar());
                if (!horasConflicto.isEmpty()) {
                    ...
                    DateFormat dateFormat = new SimpleDateFormat(sessionMBean.getFormatoFecha()+ " "+ sessionMBean.getFormatoHora());
