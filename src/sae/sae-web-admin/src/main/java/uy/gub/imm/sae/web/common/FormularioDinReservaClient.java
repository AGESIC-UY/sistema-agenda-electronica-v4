...
public class FormularioDinReservaClient {
	...
	public static void armarFormularioLecturaDinamico(Recurso recurso, Reserva reserva, UIComponent campos, List<AgrupacionDato> agrupaciones, String formatoFecha, Locale locale) throws Exception{
	...
	public static void armarFormularioEdicionDinamico(Recurso recurso, UIComponent filtroConsulta, List<AgrupacionDato> agrupaciones, String formatoFecha, Locale locale)
			throws Exception {
		...
		if (filtroConsulta.getChildCount() == 0 && recurso != null) {
			FormularioDinamicoReserva formularioDin = new FormularioDinamicoReserva(DATOS_FILTRO_RESERVA_MBEAN, FORMULARIO_ID, FormularioDinamicoReserva.TipoFormulario.CONSULTA, null, formatoFecha, locale);
			formularioDin.armarFormulario(agrupaciones, null);
			UIComponent formulario = formularioDin.getComponenteFormulario();
