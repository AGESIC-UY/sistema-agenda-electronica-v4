...
public class ConsultaMBean extends SessionCleanerMBean {
    ...
    /**
     * Realiza la búsqueda de una reserva por su identificador. No excluye a las reservas correspondientes a disponibilidades presenciales.
     *
     * @param event
     */
        ...
        if (!huboError) {
            try {
                ...
                if (reservaConsultada == null) {
                    ...
                    FormularioDinReservaClient.armarFormularioLecturaDinamico(sessionMBean.getRecursoMarcado(), reservaConsultada,
    ...
    /**
     * Realiza la búsqueda de una reserva por la combinación de fecha/hora/número. No considera a las reservas correspondientes a disponibilidades presenciales.
     *
     * @param event
     */
