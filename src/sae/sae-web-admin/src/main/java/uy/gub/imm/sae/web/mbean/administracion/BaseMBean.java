...
public abstract class BaseMBean {
    ...
    @ManagedProperty(value="#{applicationMBean}")
    protected ApplicationMBean appMBean;

    protected static final String FORM_ID = "form";

    /**
     * Si el error sucede en capa de negocio y/o en la lógica del presentación
     * de forma tal que permite volver a una página coherente, se utiliza este
     * mensaje de error genérico que se le desplega al usuario en un componente
     * message general.
     */
     ...
     * coherente con el mensaje anterior, entonces se realiza un redirect a la
     * pagina de error configurada en el faces-config para este outcome
     */
    static protected String ERROR_PAGE_OUTCOME = "error";

    public String getVersion() {
        return appMBean.getVersion();
    }
    ...
    /*
     * Añade un mensaje de error asociados a todos los componentes en pantalla
     * indicados
     */
     ...
     * Para que funcione correctamente, el componente debe estar dentro de un
     * <p:outputPanel> que a su vez esté dentro de otro <p:outputPanel> con
     * styleClass="form-group"; además, dentro del primer outputPanel debería
     * haber un componente <p:message>. También funciona con <h:panelGroup>.
    ...
    protected void addErrorMessage(Exception e, String idComponente) {
        ...
        try {
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "Error al añadir un mensaje de error", ex);
        }
    }
    ...
    /*
     * Redirecciona a la pagina asociada al respectivo outcome segun lo
     * configurado en las reglas de navegacion del faces-config
	 *
     */
    ...
    /*
     * Deshabilta el cache del navegador para la pagina que se esta
     * respondiendo.
     */
    ...
    /*
     * Devuelve el texto correspondiente a la clave indicada en el idioma
