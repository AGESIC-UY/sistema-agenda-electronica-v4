...
public class CrearDisponibilidadMBean extends BaseMBean {
    ...
    @ManagedProperty(value = "#{crearDispSessionMBean}")
    ...
    public void crearDisponibilidades(ActionEvent event) {
        ...
        try {
            ...
            if (crearDispSessionMBean.getFrecuencia() == null) {
                ...
                hayError = true;
            } else if (crearDispSessionMBean.getFrecuencia() < 1) {
            ...
            if (crearDispSessionMBean.getCupo() == null) {
                ...
                hayError = true;
            } else if (crearDispSessionMBean.getCupo() < 1) {
    ...
    private void configurarDisponibilidadesDelDia() {
        ...
        crearDispSessionMBean.setDisponibilidadesDelDiaMatutina(new RowList<>(dispMatutinas));
        crearDispSessionMBean.setDisponibilidadesDelDiaVespertina(new RowList<>(dispVespertinas));
    }
