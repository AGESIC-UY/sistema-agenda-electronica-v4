...
public class AccionMantenimientoMBean extends BaseMBean {
    ...
    private static final Logger LOGGER = Logger.getLogger(AccionMantenimientoMBean.class.getName());
    ...
    private void cargarAcciones() {
        try {
            ...
            accionesSeleccion = new RowList<>(entidades);
        } catch (Exception e) {
    ...
    public void crearAccion(ActionEvent event) {
        ...
        accion.setHost("http-remoting://localhost:8080");
    }
    ...
    public void editarAccion(ActionEvent event) {
        ...
        if (rowSelect != null) {
            ...
            List<ParametroAccion> parametros = new ArrayList<>();
            try {
                parametros = accionEJB.consultarParametrosDeLaAccion(this.accion);
            } catch (Exception ex) {
                LOGGER.warn("Error al consultar los parámetros de la acción", ex);
    ...
    public void eliminarAccion(ActionEvent event) {
        if (accionEliminar != null) {
            try {
                ...
                LOGGER.error("Error al eliminar la acción", ex);
                addErrorMessage(ex, MSG_ID);
            }
        }
    }
    ...
    public void guardarAccion(ActionEvent event) {
        ...
        try {
            ...
            LOGGER.error("Error al guardar la acción", ex);
            addErrorMessage(ex, MSG_ID);
        }
    }
