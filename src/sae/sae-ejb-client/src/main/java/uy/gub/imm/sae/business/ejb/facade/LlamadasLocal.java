...
@Local
public interface LlamadasLocal {

    public Reserva llamarASiguientePorReservaId(Recurso recurso, Integer puesto, boolean presencial, Integer reservaId) throws UserException;
