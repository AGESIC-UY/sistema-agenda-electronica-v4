...
@Local
public interface UsuariosEmpresasLocal {

    public Usuario obtenerUsuarioPorId(Integer usuarioId) throws ApplicationException;
     ...
     * consulta al servicio web, almacena los resultados en la base de datos y devuelve la lista de organismos.
     *
     *
    ...
    public List<Oficina> obtenerOficinasTramite(String tramiteId, boolean actualizar,Integer organismoId) throws ApplicationException;
    ...
    public List<Organismo> consultarOrganismosEmpresaUsuario(Usuario data) throws ApplicationException;
