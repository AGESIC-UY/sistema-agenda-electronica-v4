...
public class ValorPosible implements Serializable {
	...
	public ValorPosible (ValorPosible v){
		...
		valor = v.getValor();
		valorEnTraza = v.getValorEnTraza();
		orden = v.getOrden();
	...
	@Column (name = "valor_en_traza", length = 50)
	public String getValorEnTraza() {
		return valorEnTraza;
	}

	public void setValorEnTraza(String valorEnTraza) {
		this.valorEnTraza = valorEnTraza;
	}
	...
	public boolean equals(Object o) {
		...
		ValorPosible that = (ValorPosible) o;
