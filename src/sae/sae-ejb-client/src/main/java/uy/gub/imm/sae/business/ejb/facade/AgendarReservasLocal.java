...
@Local
public interface AgendarReservasLocal {
     ...
     */
    public Reserva marcarReserva(Disponibilidad d, OrigenReserva origen, TokenReserva token, String ipOrigen) throws UserException;
     ...
     */
    public Reserva marcarReservaValidandoDatos(Disponibilidad disponibilidad, OrigenReserva origen, Reserva reserva, TokenReserva token, String ipOrigen) throws UserException;
    ...
    public Reserva confirmarReserva(Empresa e, Reserva r, String transaccionPadreId, Long pasoPadre, boolean inicioAsistido, InformacionRequestDTO informacionRequestDTO) throws ApplicationException, BusinessException, ValidacionException, AccesoMultipleException, UserException;
    ...
    public Reserva confirmarReservaPresencial(Empresa empresa, Reserva reserva, InformacionRequestDTO informacionRequestDTO) throws ApplicationException, BusinessException, ValidacionException, AccesoMultipleException, UserException;
    ...
    /*
     * Este método es utilizado para marcar la reserva y confirmarla en un solo paso. Está pensado para ser invocado mediante el servicio web REST
     * confirmarReserva.
     *
     * @return
    ...
    public Reserva generarYConfirmarReserva(Integer idEmpresa, Integer idAgenda, Integer idRecurso, Integer idDisponibilidad, String valoresCampos,
            String idTransaccionPadre, String pasoTransaccionPadre, TokenReserva tokenReserva, String idioma, OrigenReserva origen, InformacionRequestDTO informacionRequestDTO) throws UserException;

    /*
     * Este método es utilizado para modificar una reserva. Solo se permite modificar la disponibilidad, no el recurso porque los datos a solicitar podrían ser
     * diferentes ni los datos ingresados porque podrían ser de otra persona. Está pensado para ser invocado mediante el servicio web REST modificarReserva.
     *
     * @return
     * @throws UserException
     */
    public Reserva modificarReserva(Integer idEmpresa, Integer idAgenda, Integer idRecurso, Integer idReserva, Integer idDisponibilidad,
            TokenReserva tokenReserva, String idioma, String ipOrigen, OrigenReserva origen) throws UserException;

    /*
     * Este método es utilizado para modificar una reserva. Solo se permite modificar la disponibilidad, no el recurso porque los datos a solicitar podrían ser
     * diferentes ni los datos ingresados porque podrían ser de otra persona. La reserva original mantiene todos los datos, excepto la disponibilidad a la cual
     * apunta, que cambia por la disponibilidad de la reserva nueva. Si se puede guardar la reserva original se elimina de la base de datos la reserva nueva.
    ...
    public TokenReserva confirmarReservasMultiples(Integer empresaId, Integer tokenId, String transaccionPadreId, Long pasoPadre, boolean inicioAsistido, InformacionRequestDTO informacionRequestDTO) throws UserException;

    /*
     * Elimina una reservas asociada al token indicado. Solo puede ser invocado si el token está pendiente de confirmación; una vez confirmado no se puede
     * cancelar ninguna reserva
     */
    public TokenReserva cancelarReservaMultiple(Integer tokenId, Integer reservaId) throws UserException;

    /*
     * Elimina todas las reservas asociadas al token y marca a éste como cancelado. Solo puede ser invocado si el token está pendiente de confirmación; una vez
     * confirmado no se puede cancelar
     */
    ...
    */
    public Reserva marcarReservasPares(Disponibilidad d,Disponibilidad d2, OrigenReserva origen, TokenReserva token, String ipOrigen) throws UserException;
    ...
    Reserva generarYConfirmarReservasVacunacion(Integer idEmpresa, Integer idAgenda, Integer idRecurso, Integer idDisponibilidad, String valoresCampos,
            String idTransaccionPadre, String pasoTransaccionPadre, TokenReserva tokenReserva, String idioma, OrigenReserva origen, Date fechaReservaDos, String tipoDocReservaDos, String tipoDosisReservaDos) throws UserException;
    ...
    /**
         ...
         * @throws UserException
         */
    public ResultadoEjecucion validarMoverReservas(Empresa empresa, Recurso recursoOrigen, Recurso recursoDestino, VentanaDeTiempo ventanaOrigen, VentanaDeTiempo ventanaDestino) throws UserException, ApplicationException, BusinessException;
