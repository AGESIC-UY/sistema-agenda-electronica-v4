...
public class Recurso implements Serializable, Comparable<Recurso> {
    ...
    public Recurso() {
        ...
        agrupacionDatos = new ArrayList<>();
        disponibilidades = new ArrayList<>();
        datoDelRecurso = new ArrayList<>();
        datosASolicitar = new ArrayList<>();
        validacionesPorRecurso = new ArrayList<>();
        accionesPorRecurso = new ArrayList<>();
        ...
        miPerfilConHab = false;
        miPerfilCanHab = false;
        miPerfilRecHab = false;
        miPerfilConTitulo = "";
        miPerfilConCorto = "";
        miPerfilConLargo = "";
        miPerfilConVencim = 0;
    ...
    public Recurso(Integer id, Date fechaInicio, Date fechaFin, Date fechaInicioDisp, BigDecimal latitud, BigDecimal longitud) {
        this();
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.fechaInicioDisp, other.fechaInicioDisp)) {
            return false;
        }
        if (!Objects.equals(this.fechaFinDisp, other.fechaFinDisp)) {
            return false;
        }
        if (!Objects.equals(this.diasInicioVentanaIntranet, other.diasInicioVentanaIntranet)) {
            return false;
        }
        if (!Objects.equals(this.diasVentanaIntranet, other.diasVentanaIntranet)) {
            return false;
        }
        if (!Objects.equals(this.diasInicioVentanaInternet, other.diasInicioVentanaInternet)) {
            return false;
        }
        if (!Objects.equals(this.diasVentanaInternet, other.diasVentanaInternet)) {
            return false;
        }
        if (!Objects.equals(this.cantDiasAGenerar, other.cantDiasAGenerar)) {
            return false;
        }
        if (!Objects.equals(this.visibleInternet, other.visibleInternet)) {
            return false;
        }
        if (!Objects.equals(this.sabadoEsHabil, other.sabadoEsHabil)) {
            return false;
        }
        if (!Objects.equals(this.domingoEsHabil, other.domingoEsHabil)) {
            return false;
        }
        ...
        if (!Objects.equals(this.periodoValidacion, other.periodoValidacion)) {
            return false;
        }
        if (!Objects.equals(this.reservaPendienteTiempoMax, other.reservaPendienteTiempoMax)) {
            return false;
        }
        if (!Objects.equals(this.reservaMultiplePendienteTiempoMax, other.reservaMultiplePendienteTiempoMax)) {
            return false;
        }
        return true;
    }
