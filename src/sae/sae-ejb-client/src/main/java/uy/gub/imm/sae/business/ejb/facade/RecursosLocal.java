...
@Local
public interface RecursosLocal {
    ...
    public String cargaMasiva(Agenda a, byte[] b, String codigoUsuario,TimeZone timezone,Integer organismoActual) throws UserException;

    List<Recurso> consultarRecursoByAgendaId(int agendaId) throws UserException;
}
