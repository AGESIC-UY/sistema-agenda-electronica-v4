...
public class ReporteProvider {
	...
	public static JasperPrint generarReporteDinamico(
		...
		try{
			...
			JRDataSource dataSource = new JRDinamicBeanCollectionDataSource(datos, atributoCamposDinamicos);
...
//	}
	...
	private static void agregarColumnas(JasperDesign reportDesign, List<Columna> columnas) throws JRException {
		...
		for (Columna col: columnas) {
			...
			designColCelda.setHorizontalAlignment(HorizontalAlignEnum.LEFT);
			designColCelda.setPositionType(PositionTypeEnum.FIX_RELATIVE_TO_TOP);
