...
@Local
public interface DisponibilidadesLocal {
    ...
    public List<Date> generarDisponibilidades(Recurso r, Date f, VentanaDeTiempo periodo, Boolean[] dias) throws UserException;
