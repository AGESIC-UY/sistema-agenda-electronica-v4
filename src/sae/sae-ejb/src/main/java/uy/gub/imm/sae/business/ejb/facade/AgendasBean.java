...
@Stateless
public class AgendasBean implements AgendasLocal {
    ...
    @Override
    public Agenda obtenerAgendaPorId(Integer id) {
        //Puede ser null
        return (Agenda) entityManager.find(Agenda.class, id);
    }    
    
    /**
     * Crea la agenda <b>a</b> en el sistema. Controla la unicidad del nombre de
     * la agenda entre todas las agendas vivas (fechaBaja == null). Retorna la
     * agenda con su identificador interno. Roles permitidos: Administrador
     *
    ...
    /**
     * Se realiza la baja logica de la agenda (se setea fechaBaja con la fecha
     * actual del sistema). Controla que no existan recursos vivos para esta
     * esta agenda, si es asi no se la da de baja.	* Controla que no existan
     * reservas vivas para esta esta agenda, si es asi no se la da de baja.
    ...
    public void modificarAgenda(Agenda a) throws UserException, ApplicationException {
        ...
        //agendaActual.setConIdUruguay(a.getConIdUruguay());
    ...
    public void copiarAgenda(Agenda a) throws BusinessException, ApplicationException, UserException {
        ...
        //aCopia.setConIdUruguay(a.getConIdUruguay());
