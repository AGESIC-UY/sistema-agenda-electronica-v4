...
public class DepurarReservasBean {
    ...
    private static final Logger logger = Logger.getLogger(DepurarReservasBean.class);
    ...
    @EJB
    private DepuracionReservasLocal depuracionReservas;
    ...
    public void eliminarReservasPendientes() {
        logger.info("Liberando reservas pendientes...");
        try{
	        ...
	        for (Empresa empresa : empresas) {
	            if (empresa.getDatasource() != null) {
	                ...
	                Query queryRecursos = entityManager.createNativeQuery("SELECT id,reserva_pen_tiempo_max,reserva_multiple_pend_tiempo_max FROM  "
	                    ...
	                    for (Object[] recurso : recursos) {
	                        ...
	                        try {
	                            ...
	                            query = globalEntityManager.createNativeQuery("SELECT clave, valor FROM global.ae_configuracion c WHERE c.clave IN "
	                                            + "('RESERVA_PENDIENTE_TIEMPO_MAXIMO','RESERVA_MULTIPLE_PENDIENTE_TIEMPO_MAXIMO') AND c.org_id= :organismoId");
                                    query.setParameter("organismoId", empresa.getOrganismoId());
	                        ...
	                        try {
                                    ...
                                    depuracionReservas.eliminarReservas(empresa, cFechaLimiteIndividual,cFechaLimiteMultiple, idRecurso, idsReservaInd,idsReservaMul);
