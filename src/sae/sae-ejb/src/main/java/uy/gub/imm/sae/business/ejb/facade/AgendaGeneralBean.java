...
@Stateless
public class AgendaGeneralBean implements AgendaGeneralLocal {
    ...
    /*
     * Retorna una lista de plantillas vivas (fechaBaja == null) ordenadas por orden de creacion Controla que el usuario tenga rol Administrador/Planificador
     * sobre la agenda del recurso <b>r</b>
