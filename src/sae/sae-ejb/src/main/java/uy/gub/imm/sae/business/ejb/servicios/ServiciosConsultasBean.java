...
import uy.gub.imm.sae.business.ejb.facade.ServiciosConsultasLocal;
...
@Stateless
public class ServiciosConsultasBean implements ServiciosConsultasLocal {
    ...
    public List<ReservaDTO> consultarReservasPorClave(Integer recId, Map<String, String> datosClave) throws BusinessException {
        ...
        if (datosOpcionales.size() > 0) {
            ...
            while (itD.hasNext()) {
                ...
                List<Reserva> reservasAux = new ArrayList<>();
                ...
                while (itR.hasNext()) {
                    ...
                    while (itDR.hasNext()) {
                        ...
                        if (Objects.equals(datoResAux.getDatoASolicitar().getId(), dato1.getId())) {
                            queda = false;
                        }
                    }
                    if (queda) {
