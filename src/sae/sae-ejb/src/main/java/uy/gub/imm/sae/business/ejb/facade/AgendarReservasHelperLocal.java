...
public interface AgendarReservasHelperLocal {
	...
	public Reserva crearReservaPendiente(Disponibilidad d, OrigenReserva origen, TokenReserva token, String ipOrigen);
        public Reserva crearReservasParesPendiente(Disponibilidad d,Disponibilidad d2, OrigenReserva origen, TokenReserva token, String ipOrigen) throws ApplicationException;
