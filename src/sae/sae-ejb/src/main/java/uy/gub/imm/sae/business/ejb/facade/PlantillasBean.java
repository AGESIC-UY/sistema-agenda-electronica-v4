...
@Stateless
public class PlantillasBean implements PlantillasLocal {
     ...
     * Tambien se le setea a Anios, DiasDeLaSemana, DiasDelMes y Meses la plantilla Se permite setear todos sus atributos menos la fechaBaja. Controla:
     * horaInicio, horaFin y frecuencia son obligatorios horaInicio < horaFin
     *	frecuencia > 0
     * cupo > 0 Retorna la plantilla con su identificador interno.
     *
    ...
    /**
     * Se realiza la baja lógica de la plantilla (se setea fechaBaja con la fecha actual del sistema). Controla que el usuario tenga rol Planificador sobre la
    ...
    /**
     * Modificación de una plantilla <b>p</b>. Se permite modificar todos sus atributos menos la fechaBaja. Controla: Los mismos controles que se aplican en
     * crearPlantilla
     *
