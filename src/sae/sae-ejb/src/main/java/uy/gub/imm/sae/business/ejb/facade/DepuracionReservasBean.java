...
@Stateless
public class DepuracionReservasBean implements DepuracionReservasLocal {
    
    @PersistenceContext(unitName = "SAE-EJB")
    private EntityManager entityManager;
    
    
    private static final Logger logger = Logger.getLogger(DepuracionReservasBean.class);
