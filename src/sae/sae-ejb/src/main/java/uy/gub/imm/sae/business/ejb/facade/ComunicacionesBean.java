...
/**
 * Estos metodos son usados para enviar las comunicaciones cada vez que un usuario reserva o cancela una reservación. Por el momento hay cuatro tipos de
 * comunicaciones: por mail, por sms, por texto a voz y por mi perfil. Para enviar un mail, es necesario que exista un campo llamado "Mail" dentro de la
 * agrupacion "DatosPersonales". El texto del mail se obtiene incorporando los datos de la reserva en el texto definido para el envío de mail en la Agenda. En
 * el caso de SMS y TAV en realidad no se envía nada sino que se escribe en una tabla llamada ae_comunicaciones a la espera de que un proceso externo los tome y
 * marque como procesadas. Para poder enviar un SMS es necesario que exista un campo llamado "TelefonoMovil" dentro de la agrupacion "DatosPersonales". Para
 * poder enviar un TAV es necesario que exista un campo llamado "TelefonoFijo" dentro de la agrupacion "DatosPersonales". En el caso de Mi Perfil, se debe tener
 * el número de documento del ciudadano.
 */
@Stateless
public class ComunicacionesBean implements ComunicacionesLocal {

    private static final Logger LOGGER = Logger.getLogger(ComunicacionesBean.class);
    ...
    public void enviarComunicacionesConfirmacion(Empresa empresa, String linkCancelacion, String linkModificacion, Reserva reserva, String idioma, String formatoFecha, String formatoHora) throws UserException {
        ...
        boolean mipOk =  almacenarSmsYTav(Comunicacion.Tipo2.RESERVA, reserva, formatoFecha, formatoHora);
     ...
     *
     * @param empresa
     * @param templateLinkCancelacion
     * @param templateLinkModificacion
     * @param tokenReserva
     * @param idioma
     * @param formatoFecha
     * @param formatoHora
    ...
    public void enviarComunicacionesConfirmacion(Empresa empresa, String templateLinkCancelacion, String templateLinkModificacion, TokenReserva tokenReserva, String idioma, String formatoFecha, String formatoHora) throws UserException {
        ...
        //Procesar cada reserva e ir conformando un cuerpo de texto para enviar a la persona que realiza las reservas
        ...
        for (Reserva reserva : reservas) {
            if (reserva.getEstado().equals(Estado.R)) {
                ...
                cuerpos.append("<br />Documento: ").append(reserva.getTipoDocumento()).append(" ").append(reserva.getNumeroDocumento()).append("<br /><br />").append(cuerpo);
    ...
    public void enviarComunicacionesCancelacion(Empresa empresa, Reserva reserva, String idioma, String formatoFecha, String formatoHora, String asunto, String cuerpo) throws UserException {
        ...
        //Enviar aviso a MiPerfil
        enviarAvisoMiPerfil(empresa, reserva, Comunicacion.Tipo2.CANCELA);
    }
