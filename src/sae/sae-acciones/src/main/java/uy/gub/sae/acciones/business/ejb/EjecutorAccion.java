...
public interface EjecutorAccion {
     ...
     *
     * @param nombreAccion
     * @param params es un hash que tiene en forma de <key,value> los datos ingresados por el usuario que realizó la reserva de forma tal que key = nombre del
     * parametro y value = el valor ingresado. Habrán tantos parámetros como los defindos por la accion concreta. Adicionalmente se espera que este hash tenga
     * otra serie de parametros extras:
