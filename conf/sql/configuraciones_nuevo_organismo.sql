...
BEGIN
	...
	INSERT INTO global.ae_configuracion (clave, valor,org_id) VALUES('WS_NOVEDADES_XML_LOG', 'false',orgid);
	INSERT INTO global.ae_configuracion (clave, valor,org_id) VALUES('CARGA_MASIVA_DIAS_RECURSOS_NUEVOS', '30',orgid);
	INSERT INTO global.ae_configuracion (clave, valor,org_id) VALUES('CARGA_MASIVA_DIAS_RECURSOS_EXISTENTES', '15',orgid);
