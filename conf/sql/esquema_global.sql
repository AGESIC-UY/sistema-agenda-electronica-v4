...
CREATE TABLE ae_rel_usuarios_organismos (
    usuario_id integer NOT NULL,
    org_id integer NOT NULL
);
ALTER TABLE ae_rel_usuarios_organismos OWNER TO sae;
...
INSERT INTO ae_textos (codigo, texto) VALUES ('el_orden_de_la_agrupacion_es_obligatorio', 'El orden de la agrupación es obligatorio');
...
INSERT INTO ae_textos (codigo, texto) VALUES ('asociar_validaciones_a_recurso', 'Asociar validaciones al recurso');
...
INSERT INTO ae_textos (codigo, texto) VALUES ('no_se_pudo_enviar_notificacion_de_confirmacion_tome_nota_de_los_datos_de_la_reserva', 'Tenga en cuenta que no se ha podido enviar la notificación por correo electrónico; tome nota de los datos de la reserva');
...
INSERT INTO ae_textos (codigo, texto) VALUES ('accion_servicio_descripcion', 'Relativo a  "java:jboss/exported/"; de la forma {war}-{class}!uy.gub.sae.acciones.business.ejb.EjecutorAccionRemote');
INSERT INTO ae_textos (codigo, texto) VALUES ('accion_host_descripcion', 'Por defecto es "http-remoting://localhost:8080"');
INSERT INTO ae_textos (codigo, texto) VALUES ('validacion_servicio_descripcion', 'Relativo a  "java:jboss/exported/"; de la forma {war}-{class}!uy.gub.imm.sae.validaciones.business.ejb.ValidadorReservaRemote');
INSERT INTO ae_textos (codigo, texto) VALUES ('validacion_host_descripcion', 'Por defecto es "http-remoting://localhost:8080"');
...
INSERT INTO ae_textos (codigo,texto) VALUES ('seleccion_organismo','Selección de organismo');
INSERT INTO ae_textos (codigo,texto) VALUES ('dispone_varios_organismos','Dispone de varios organismos, debe seleccionar uno para operar');
INSERT INTO ae_textos (codigo,texto) VALUES ('debe_selecionar_un_organismo','Debe seleccionar un organismo');
INSERT INTO ae_textos (codigo,texto) VALUES ('configuracion_del_organismo','Configuración del organismo');
...
INSERT INTO ae_textos (codigo, texto) VALUES ('reserva_pendiente_tiempo_max_es_obligatoria', 'El tiempo máximo para una reserva pendiente es obligatoria');
INSERT INTO ae_textos (codigo, texto) VALUES ('reserva_multiple_pendiente_tiempo_max_es_obligatoria', 'El tiempo máximo para las reservas múltiples pendientes es obligatoria');
...
INSERT INTO ae_textos (codigo, texto) VALUES ('actualizacion_recursos', 'Se han modificado x recursos');
...
INSERT INTO ae_textos(codigo, texto) VALUES ('consultar_usuarios_por_empresa', 'Consultar usuarios por empresa');
INSERT INTO ae_textos(codigo, texto) VALUES ('roles', 'Roles');
INSERT INTO ae_textos(codigo, texto) VALUES ('valor_en_traza', 'Valor en Traza');
INSERT INTO ae_textos(codigo, texto) VALUES ('ingrese_el_numero_de_puesto_en_el_campo_correcto', 'Ingrese el numero de puesto en el campo correcto');
...
ALTER TABLE ONLY ae_configuracion ADD CONSTRAINT ae_configuracion_pk PRIMARY KEY (id);
...
ALTER TABLE ONLY ae_rel_usuarios_organismos ADD CONSTRAINT ae_rel_usuarios_organismos_pkey PRIMARY KEY (usuario_id, org_id);
...
CREATE UNIQUE INDEX idx_clave_org ON "global".ae_configuracion(clave, org_id);
