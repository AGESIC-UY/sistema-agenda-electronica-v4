...
CREATE SCHEMA sae_development;

ALTER SCHEMA sae_development OWNER TO sae;

SET search_path = sae_development, pg_catalog;
...
CREATE TABLE ae_recursos (
    ...
    mi_perfil_con_hab bool NOT NULL DEFAULT true,
	  ...
	  mi_perfil_con_cor varchar(255) NULL DEFAULT NULL,
	  ...
	  mi_perfil_can_cor varchar(255) NULL DEFAULT NULL,
	  ...
	  mi_perfil_rec_cor varchar(255) NULL DEFAULT NULL,
...
CREATE INDEX ae_tokens_reservas_aere_id_idx ON sae_development.ae_tokens_reservas (aere_id);
CREATE INDEX ae_tokens_reservas_ultima_reserva_idx ON sae_development.ae_tokens_reservas (ultima_reserva);
CREATE INDEX ae_tokens_reservas_fecha_inicio_idx ON sae_development.ae_tokens_reservas (fecha_inicio);
CREATE INDEX ae_tokens_reservas_estado_idx ON sae_development.ae_tokens_reservas (estado);
...
ALTER TABLE ONLY ae_acciones_miperfil_recurso ADD CONSTRAINT accion_recurso_fkey FOREIGN KEY (recurso_id) REFERENCES ae_recursos (id);

--
-- PERMISOS
--

REVOKE ALL ON SCHEMA sae_development FROM PUBLIC;
REVOKE ALL ON SCHEMA sae_development FROM sae;
GRANT ALL ON SCHEMA sae_development TO sae;
GRANT ALL ON SCHEMA sae_development TO postgres;
